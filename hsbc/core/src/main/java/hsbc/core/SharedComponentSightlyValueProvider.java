...
@org.osgi.service.component.annotations.Component(immediate = true, service = BindingsValuesProvider.class,
        property = {"javax.script.name=sightly", Constants.SERVICE_RANKING + ":Integer=1001"})
@Service
public class SharedComponentSightlyValueProvider implements BindingsValuesProvider {
    private static final Logger log = LoggerFactory.getLogger(hsbc.core.SharedComponentSightlyValueProvider.class);
